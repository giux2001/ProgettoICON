...
def preprocess_data(balanced = True, only_categorical = False, three_class = True):
    ...
    if three_class:
        if balanced:
            plot_histogram(y_train, 'BalancedThreeClass')
        else:
            plot_histogram(y_train, 'NotBalancedThreeClass')
    else:
        if balanced:
            plot_histogram(y_train, 'BalancedBinary')
        else:
            plot_histogram(y_train, 'NotBalancedBinary')
